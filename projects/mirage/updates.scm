(
    ...
    (descr "The Mirage paper on the low-level implementation details of the Xen backend was accepted at ASPLOS. The team is currently working on revising the paper for camera-ready (and tagging the release to include it in the final version, to encourage reproducable results).")
)
(
  (date 2012-08-27)
  (ty (Event "xensummit-2012"))
  (descr "Anil Madhavapeddy described the low-level portions of Mirage and how they map onto the Xen interfaces, discussed future directions, and showed off the 100KB self-hosted microkernel presentation. The [Bromium](http://bromium.com) team were interested in looking at this on their microvisor, and datacenter folks wanted to know if this would help with lightweight datacenter proxies.")
)
(
  (date 2012-09-25)
  (ty (Event "xensummit-2012"))
  (descr "Anil Madhavapeddy delivered roughly the same XenSummit talk at the Princeton departmental seminar. There was a *lot* of interest in the software-defined networking libraries, as Princeton has major efforts ongoing to apply high-level programming discipline to network construction. Andrew Appel also described his ongoing Compcert efforts and how Mirage could fit into this in the longer-term.")
)
(
  (date 2012-09-14)
...
(
  ...
  (descr "Dave Scott explained the background behind using OCaml in the Xen Cloud Platform, and demonstrated the integration of Mirage and Xen in a future update.  His slides were [self-hosted](http://github.com/djs55/techmesh-2012) using a Mirage webserver running Xen on his laptop.")
)
(
  (date 2012-12-06)
